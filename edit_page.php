    ...
    <div class="container mt-3">
      ...
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" name="name" class="form-control" id="name" value="<?php echo $row['name'] ?>" aria-describedby="">
          <input type="hidden" name="id" class="form-control" id="id" value="<?php echo $row['id'] ?>" aria-describedby="">
        </div>

        <div class="form-group">
          <label for="inputState">Gender</label><?php
          if($row['gender'] == "") {?>
